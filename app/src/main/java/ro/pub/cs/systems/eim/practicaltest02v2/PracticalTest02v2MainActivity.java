...
public class PracticalTest02v2MainActivity extends AppCompatActivity {
    ...
    private final GetInformationButtonClickListener getInformationButtonClickListener = new GetInformationButtonClickListener();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWeatherForecastButton.setOnClickListener(getInformationButtonClickListener);
